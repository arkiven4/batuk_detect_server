...
fpath = os.path.join("/run/media/viblab/Markov2/Pras/PKM/TB/public_dataset", 'feb93862-2508-4ca7-a74e-77701bbcd3c0.wav')
...
print(class_name[np.argmax(output.cpu().numpy())])